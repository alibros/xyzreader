...
/**
 * Created by Ali on 11/08/15.
 */
public class AcrticlListRecyclerViewAdapter  extends  RecyclerView.Adapter<AcrticlListRecyclerViewAdapter.ViewHolder>{


    private Cursor mCursor;
    private Context mContext;

    public AcrticlListRecyclerViewAdapter(Context context, Cursor cursor) {
        mContext = context;
        mCursor = cursor;
    }
